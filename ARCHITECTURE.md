...
- Pattern: Compares two file byte slices using Tree-sitter parsers, classifying symbol changes into added, removed, and modified entries along with line-count deltas for code files while treating JSON/YAML as data files.
