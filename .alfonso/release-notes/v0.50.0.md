...
With the gate off, the edit surface is byte-identical to v0.49 — schemas, prompts, and behavior are unchanged. The engine ships fully tested (137 unit tests, a 128-fixture parity corpus against the reference implementation, and release-profile performance gates) and works across all transports: standalone, daemon, and MCP.
